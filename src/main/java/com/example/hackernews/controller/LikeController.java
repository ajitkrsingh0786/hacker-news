...
public class LikeController {
    ...
    public String upVotePost(@RequestParam(name = "postId") String postId, @RequestParam(name = "userId", required =
            false, defaultValue = "") String userId, @RequestParam(name = "goTo") String goTo, Principal principal) {
    ...
    public String downVotePost(@RequestParam(name = "postId") String postId,
                               @RequestParam(name = "userId") String userId, @RequestParam(name = "goTo") String goTo) {
